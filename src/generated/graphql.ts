...
export type GetAccountByUserIdQuery = {
  __typename?: "Query";
  account: Array<{
    __typename?: "Account";
    id: string;
...
export function getSdk(
  ...
  return {
    getAccountByUserId(
      variables: GetAccountByUserIdQueryVariables,
      requestHeaders?: Dom.RequestInit["headers"]
    ): Promise<GetAccountByUserIdQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetAccountByUserIdQuery>(
    ...
    addAccount(
      variables: AddAccountMutationVariables,
      requestHeaders?: Dom.RequestInit["headers"]
    ): Promise<AddAccountMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<AddAccountMutation>(AddAccountDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        "addAccount",
    ...
    addUser(
      ...
      requestHeaders?: Dom.RequestInit["headers"]
    ): Promise<AddUserMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<AddUserMutation>(AddUserDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        "addUser",
